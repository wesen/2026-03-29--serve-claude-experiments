...
function buildSegments(text, anns) {
  ...
  for (const m of matches) {
    ...
    const display = m.ann.activeSuggestion !== null ? m.ann.suggestions[m.ann.activeSuggestion].text : m.ann.original;
...
function MacWindow({ title, x, y, w, h, z, onClose, onFocus, onDragStart, onResizeStart, children }) {
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", left: 0, right: 0, textAlign: "center", pointerEvents: "none" } }, /* @__PURE__ */ React.createElement("span", { style: {
    ...
    /* @__PURE__ */ React.createElement("div", { style: { flex: 1, overflow: "auto", minHeight: 0 } }, children),
    onResizeStart && /* @__PURE__ */ React.createElement(
      "div",
      {
...
function EditorApp() {
  ...
  const toggleSuggestion = (annId, sugIdx) => {
    setAnnotations((prev) => prev.map(
      (a) => a.id !== annId ? a : { ...a, activeSuggestion: a.activeSuggestion === sugIdx ? null : sugIdx }
    ));
  };
  const applyDSL = () => {
    try {
...
Respond ONLY with a JSON array of 1-3 suggestion objects. Each has "text" (replacement) and "rationale" (1 sentence). No markdown, no backticks, just raw JSON array.`,
  ...
  return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    fontSize: 12,
    overflow: "hidden"
  } }, /* @__PURE__ */ React.createElement("link", { href: "https://fonts.googleapis.com/css2?family=Silkscreen:wght@400;700&display=swap", rel: "stylesheet" }), /* @__PURE__ */ React.createElement("div", { style: {
    height: 24,
    background: "#fff",
    borderBottom: "2px solid #000",
    display: "flex",
    ...
    position: "relative",
    zIndex: 99999
  } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14, marginRight: 14 } }, "\u{1F34E}"), [
    { label: "File", items: [{ label: "  About Editor", action: () => {
    } }] },
    { label: "View", items: [
      { label: (showDSL ? "\u2713" : "  ") + " DSL Editor", action: () => {
        setShowDSL(!showDSL);
        if (!showDSL) focus("dsl");
      } },
      { label: (showChat ? "\u2713" : "  ") + " Chat", action: () => {
        setShowChat(!showChat);
        if (!showChat) focus("chat");
      } }
    ] }
  ].map((menu) => /* @__PURE__ */ React.createElement("div", { key: menu.label, style: { position: "relative" } }, /* @__PURE__ */ React.createElement(
    "div",
    {
      onClick: (e) => {
        e.stopPropagation();
        setMenuOpen(menuOpen === menu.label ? null : menu.label);
      },
      style: {
        padding: "2px 12px",
        cursor: "pointer",
        background: menuOpen === menu.label ? "#000" : "transparent",
        color: menuOpen === menu.label ? "#fff" : "#000",
        fontSize: 12
      }
    },
    menu.label
  ), menuOpen === menu.label && /* @__PURE__ */ React.createElement("div", { style: {
    position: "absolute",
    top: "100%",
    left: 0,
    background: "#fff",
    ...
    minWidth: 180,
    zIndex: 1e5
  } }, menu.items.map((item, i) => /* @__PURE__ */ React.createElement(
    "div",
    {
      key: i,
      onClick: (e) => {
    ...
    item.label
  )))))), /* @__PURE__ */ React.createElement("div", { style: { position: "relative", width: "100%", height: "calc(100% - 24px)" } }, /* @__PURE__ */ React.createElement(
    MacWindow,
    {
    ...
    /* @__PURE__ */ React.createElement("div", { ref: articleRef, style: {
      padding: "16px 20px",
      ...
      return /* @__PURE__ */ React.createElement("p", { key: pi, style: { marginBottom: 16 } }, segs.map((seg, si) => {
        if (!seg.ann) return /* @__PURE__ */ React.createElement("span", { key: si }, seg.text);
        ...
        return /* @__PURE__ */ React.createElement(
          ...
          seg.text,
          /* @__PURE__ */ React.createElement("sup", { style: {
            fontSize: 7,
            fontFamily: "'Silkscreen', monospace",
            marginLeft: 1,
            color: isActive ? "#fff" : "#666"
          } }, TYPE_CONFIG[t].pattern)
        );
      }));
    }))
  ), /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { padding: 12 } }, !active ? /* @__PURE__ */ React.createElement("div", { style: { color: "#888", fontSize: 11, padding: 24, textAlign: "center" } }, "Click an underlined annotation", /* @__PURE__ */ React.createElement("br", null), "in the document to inspect.") : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: {
    ...
    } }, TYPE_CONFIG[active.type].pattern, " ", TYPE_CONFIG[active.type].label), /* @__PURE__ */ React.createElement("div", { style: {
      ...
      fontStyle: "italic",
      color: "#555"
    } }, '"', active.original, '"'), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, marginBottom: 8, color: "#888" } }, "SUGGESTIONS (", active.suggestions.length, ")"), active.suggestions.map((sug, i) => {
      ...
      } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "Georgia, serif", fontSize: 13, flex: 1 } }, '"', sug.text, '"'), /* @__PURE__ */ React.createElement(
        "button",
        {
  ...
  ), showDSL && /* @__PURE__ */ React.createElement(
    MacWindow,
    {
      title: "DSL Editor",
      ...wins.dsl,
    ...
    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", height: "100%" } }, /* @__PURE__ */ React.createElement(
      "textarea",
      {
        value: dslText,
        onChange: (e) => {
      ...
      fontSize: 10,
      color: dslError ? "#000" : "#888",
      fontWeight: dslError ? 700 : 400
    } }, dslError ? `\u26A0 ${dslError}` : "Edit JSON \u2192 Apply"), /* @__PURE__ */ React.createElement("button", { onClick: applyDSL, style: {
      border: "2px solid #000",
      background: "#000",
      color: "#fff",
      fontSize: 10,
  ...
  ), showChat && /* @__PURE__ */ React.createElement(
    MacWindow,
    {
      title: "Ask Editor",
      ...wins.chat,
    ...
    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", height: "100%" } }, /* @__PURE__ */ React.createElement("div", { style: {
      flex: 1,
      overflowY: "auto",
      padding: 10,
      borderBottom: "2px solid #000",
      minHeight: 0
    } }, chatMsgs.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { color: "#888", fontSize: 10, textAlign: "center", padding: 24 } }, "Select text in the document,", /* @__PURE__ */ React.createElement("br", null), "then click \u2726 to start."), chatMsgs.map((m, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: {
      marginBottom: 8,
      fontSize: 11,
    ...
    } }, m.role === "user" && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 9, color: "#888" } }, "YOU: "), m.role === "assistant" && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 9, color: "#888" } }, "EDITOR: "), m.text)), chatLoading && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888" } }, "Thinking..."), /* @__PURE__ */ React.createElement("div", { ref: chatEndRef })), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexShrink: 0 } }, /* @__PURE__ */ React.createElement(
      "input",
      {
        value: chatInput,
    ...
    ), /* @__PURE__ */ React.createElement("button", { onClick: sendChat, style: {
      border: "none",
  ...
  ), selPopup && /* @__PURE__ */ React.createElement("div", { style: {
    position: "fixed",
    left: selPopup.x,
    top: selPopup.y,
...
const __artifactDefault = EditorApp;
