...
- [x] Step 1: Import pbui-gog.jsx and run server in tmux <!-- t:l142 -->
- [x] Step 2: Switch to ~/Downloads/pbui-gog(1).jsx (larger multi-doc version) <!-- t:xzc3 -->
- [x] Step 3: Add CSV upload + OPFS persistence <!-- t:4a4a -->
- [x] Step 4: Write ZIP export implementation guide <!-- t:vh3m -->
